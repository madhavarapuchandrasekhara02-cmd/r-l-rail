  ...
  if (error || !data) {
    return (
      <div className="min-h-screen bg-[#FAF9F6] flex flex-col items-center justify-center p-6 text-center">
        ...
        <button onClick={() => router.push('/admin/orders')} className="px-6 py-3 bg-[#4A3525] text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-[#B37943] transition-colors">
          Back to Orders
        </button>
      </div>
    )
