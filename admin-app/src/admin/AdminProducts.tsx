            ...
            <div key={product.id} className="group bg-white rounded-[1.5rem] border border-[#E5C492] overflow-hidden shadow-[var(--shadow-sm)] hover:shadow-[var(--shadow-lg)] transition-all duration-500">
              <div className="aspect-square bg-[#FAF9F6] relative overflow-hidden">
                ...
                <div className="absolute bottom-3 left-3 flex gap-2">
                  ...
                  <span className="text-[9px] font-bold text-[#B37943] uppercase tracking-widest bg-white/90 backdrop-blur px-2.5 py-1.5 rounded-lg shadow-sm border border-[#E5C492]">
                    Ord: {product.display_order ?? 999}
                  </span>
                </div>
              </div>
              <div className="p-5">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#FAF9F6]/50 border-b border-[#E5C492]">
                  ...
                  <th className="px-6 py-4 text-[9px] font-bold text-[#B37943] uppercase tracking-[0.2em]">Order</th>
              ...
              <tbody className="divide-y divide-[#FAF9F6]">
                {products.map((product) => (
                  <tr key={product.id} className="group hover:bg-[#FAF9F6]/30 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <p className="text-xs font-semibold text-[#B37943]">{product.display_order ?? 999}</p>
                    </td>
                    <td className="px-6 py-4">
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    <div className="grid sm:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-[#4A3525] uppercase tracking-widest px-1 flex items-center gap-2">
                          Display Order 
                          <span className="text-[9px] text-[#B37943] normal-case bg-[#E5C492]/20 px-2 py-0.5 rounded-full">Homepage Priority</span>
                        </label>
                        <input
                          type="number"
                          value={form.display_order ?? ''}
                          onChange={(e) => setForm({ ...form, display_order: parseInt(e.target.value) || 0 })}
                          className="w-full px-5 py-4 bg-white border-2 border-[#B37943] rounded-2xl text-sm font-bold text-[#4A3525] focus:outline-none focus:ring-4 focus:ring-[#B37943]/10 shadow-[0_0_15px_rgba(179,121,67,0.15)] transition-all"
                          placeholder="e.g. 1"
                        />
                      </div>
                    </div>
